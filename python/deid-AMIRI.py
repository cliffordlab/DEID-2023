...
def check_for_name(patient, note, chunk, output_handle):
    offset = 27
    output_handle.write('Patient {}\tNote {}\n'.format(patient, note))
    firs_name_repo = get_string_repo(
        '/home/emo/Desktop/Semester4/BMI500/W8/AMIRI_BMI500_deid_2023/lists/doctor_first_names.txt')
    last_name_repo = get_string_repo(
        '/home/emo/Desktop/Semester4/BMI500/W8/AMIRI_BMI500_deid_2023/lists/doctor_last_names.txt')
    name_repo = firs_name_repo + last_name_repo
    for name in name_repo:
        name = name.lower()
...
def check_for_name_pro(patient, note, chunk, output_handle):
    offset = 27
    output_handle.write('Patient {}\tNote {}\n'.format(patient, note))

    name_repo = []
    for file in get_all_files_path('/home/emo/Desktop/Semester4/BMI500/W8/AMIRI_BMI500_deid_2023/lists/'):
        if '_name_' in file:
            name_repo.extend(get_string_repo(file))
...
def deid_phone(text_path='id.text', output_path='name.phi'):
    """
    Inputs:
        ...
        with open(text_path) as text:
            ...
            for line in text:
                ...
                if len(record_end):
                    ...
                    # check_for_name_pro(
                    #     patient, note, chunk.strip(), output_file)
