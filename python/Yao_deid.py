...
def check_for_email(patient,note,chunk, output_handle):
    """
    Inputs:
    ...
    for match in email_reg.finditer(chunk):
...
def deid_email(text_path= 'id.text', output_path = 'email.phi'):
    """
    Inputs: 
        ...
        with open(text_path) as text:
            ...
            for line in text:
                ...
                if len(record_end):
                    ...
                    check_for_email(patient,note,chunk.strip(), output_file)
...
if __name__== "__main__":
    ...
    deid_email(sys.argv[1], sys.argv[2])
